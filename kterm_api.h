...
#define KTERM_VERSION_STRING "2.7.11"
...
// Terminal Compute Shader Preamble
    ...
    "layout(buffer_reference, scalar) buffer ConfigBuffer {\n"
    "    float crt_curvature; float scanline_intensity; float glow_intensity;\n"
    "    float noise_intensity; float visual_bell_intensity; float voice_energy;\n"
    "    uint flags; uint font_cell_width; uint font_cell_height;\n"
