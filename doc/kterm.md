# kterm.h - Technical Reference Manual v2.6.14
...
*   [1. Overview](#1-overview)
    ...
    *   [1.3. Known Limitations (v2.6.14)](#13-known-limitations-v2614)
...
### 1.3. Known Limitations (v2.6.14)

While K-Term is production-ready, users should be aware of the following limitations in the v2.6.14 release:
